...
//stoch_simul(order=1, irf=40) Y, C, I, dP, R, X, S, F, Ygap, Rgap;
...
Zpi, Znw, Zpif, Zx, Zg, Zw, Zcp, Zmc, Ygap, Rgap, y, r;

shock_decomposition   Y_obs, C_obs, R_obs, dP_obs, Ygap, Rgap, y, r;
//be